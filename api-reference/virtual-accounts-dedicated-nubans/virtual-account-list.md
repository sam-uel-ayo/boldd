...
Retrieve every virtual account generated under your business.

**Endpoint**

<mark style="color:blue;">`GET`</mark> `{{base_url}}/virtualaccounts`
...
```bash
curl --location '{{base_url}}/virtualaccounts' \
...
{% code overflow="wrap" lineNumbers="true" %}
```javascript
const response = await fetch('{{base_url}}/virtualaccounts', {
...
curl_setopt_array($curl, array(
  CURLOPT_URL => '{{base_url}}/virtualaccounts',
...
var request = http.Request('POST', Uri.parse('{{base_url}}/virtualaccounts'));
...
```json
{
  ...
  "data": [
    ...
    },
    {
      ...
      "bank_code": "120001",
      "account_name": "BOLDD - akinade johnson",
      "lastdate_used": "",
      "tracking_id": "001002",
      "account_status": "Active",
